...
此时因为修改了sshd密钥认证文件的位置，所以默认的sshd的selinux policy就无法正确的给文件正确的lable，所以此时需要我们手动来修正，具体的修正过程，见[selinux sshd public key lable](/linux/advance/selinux_1.0.2_sshd_public_key_lable.md)