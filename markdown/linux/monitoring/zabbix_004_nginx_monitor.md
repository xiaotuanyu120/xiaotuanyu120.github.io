---
title: zabbix: 实践 - nginx监控
date: 2015-12-01 16:05:00
categories: linux/monitoring
tags: [zabbix,nginx]
---

## 1. NGINX开启状态收集
### 1.1 查看nginx编译时是否将状态模块编译
``` bash
...
# server accepts handled requests，成功处理的连接数，成功创建的握手数，总共处理的请求数
