---
title: 30.0.0: mysql主从同步
date: 2015-01-30 20:33:00
categories: linux/basic
tags: [linux,mysql]
---

## 1. 环境介绍
master主机，将作为mysql主配置

``` bash
ifconfig|grep -A1 eth1
...
``` bash
# master
mysqldump -u root -p discuz > ~/discuz.20150131.sql

# slave
mysql -u root -p discuz < discuz.20150131.sql
```
