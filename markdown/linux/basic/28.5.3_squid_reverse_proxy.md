...
cache_peer 45.114.10.220 parent 80 0 originserver name=example
cache_peer_domain example linux.example.com
#type:parent,sibling or multicast
#name=a，cache_peer的别名

## 访问控制
acl our_sites dstdomain linux.example.com
http_access allow our_sites
cache_peer_access example allow our_sites
cache_peer_access example deny all
=================================================
squid -k check
squid -k rec

curl -xlocalhost:80 linux.example.com -I
HTTP/1.0 302 Moved Temporarily
Server: nginx/1.8.0
Date: Thu, 22 Dec 2016 02:08:49 GMT
Content-Type: text/html; charset=utf-8
Content-Length: 217
Location: http://linux.example.com/home
