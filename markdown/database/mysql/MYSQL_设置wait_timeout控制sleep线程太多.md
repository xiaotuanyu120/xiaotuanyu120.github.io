---
title: MYSQL: 设置wait_timeout控制sleep线程太多
date: 2016-02-06 11:25:00
...
### 分析及解决
sleep命令解释: The thread is waiting for the client to send a new statement to it. 官方解释为,等待客户端发送新的语句
